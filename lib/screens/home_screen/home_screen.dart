...
import 'package:artbot/screens/home_screen/widgets/image_dialogbox.dart';
    ...
    return Consumer<HomeScreenProvider>(
      ...
      return Scaffold(
        ...
        floatingActionButton: AbsorbPointer(
          absorbing: homeScreenProvider.isLoading,
          child: GradientTextButton(
            onPressed: () {
              homeScreenProvider.toggleLoading();
              homeScreenProvider
                  .generate(homeScreenProvider.promtEditingController.text)
                  .then((file) {
                if (file == null) {
                  homeScreenProvider.toggleLoading();
                  ...
                  scaffold.showSnackBar(
                    const SnackBar(
                      content: Text('Please check your API key'),
                  ...
                  homeScreenProvider.toggleLoading();
                  homeScreenProvider.saveToHistory(
                      homeScreenProvider.promtEditingController.text);
                  showDialog(
                    context: context,
            ...
            text: homeScreenProvider.isLoading ? "GENERATING" : 'GENERATE',
            gradientColors: homeScreenProvider.isLoading
                ? const [
                    Colors.white,
                    Colors.grey,
                  ]
